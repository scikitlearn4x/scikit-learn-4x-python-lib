...
if __name__ == '__main__':
    arr1 = np.array(np.random.random((3,2,2)), dtype=np.float64) + 0.01
    arr2 = np.array(np.random.random((1,2,2)), dtype=np.float64) + 0.01

    print_array(arr1, 'array1')
    print_array(arr2, 'array2')
    print_array(arr1 / arr2, 'expected')
